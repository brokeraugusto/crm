...
export function Sidebar() {
  ...
  const sidebarWidth = open || isMobile && openMobile ? "w-64" : "w-16";
        ...
        <div className="flex flex-col h-[calc(100%-4rem)] overflow-y-auto">
          <nav className="flex-1 px-2 py-4 space-y-1">
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Dashboard</span>}
            </NavLink>
            <NavLink 
              to="/leads" 
              onClick={handleLinkClick} 
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Leads</span>}
            </NavLink>
            <NavLink 
              to="/imoveis" 
              onClick={handleLinkClick} 
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Imóveis</span>}
            </NavLink>
            <NavLink 
              to="/agenda" 
              onClick={handleLinkClick} 
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Agenda</span>}
            </NavLink>
            <NavLink 
              to="/documentos" 
              onClick={handleLinkClick} 
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Documentos</span>}
            </NavLink>
            <NavLink 
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Base de Conhecimento</span>}
            </NavLink>
            ...
            {isMasterAdmin && (
              <NavLink 
                ...
                onClick={handleLinkClick} 
                className={({isActive}) => 
                  `flex items-center px-3 py-2 rounded-md mb-1 mt-4 
                  ${isActive ? activeClass : normalClass}`
                }
              >
                <UserCog className="w-5 h-5 mr-3 flex-shrink-0" />
                {(open || isMobile && openMobile) && <span className="truncate">Administração</span>}
              </NavLink>
            )}
          </nav>
          ...
          >
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Configurações</span>}
            </NavLink>
            <button 
            ...
            >
              ...
              {(open || isMobile && openMobile) && <span className="truncate">Sair</span>}
            </button>
          </div>
        </div>
      </aside>
